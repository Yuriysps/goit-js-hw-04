...
function calcAverageCalories(days) {
    ...
    for (const day of days) {
        ...
        allCaloriesValue += day.calories
        allDays++ ;
        

    }

      return allCaloriesValue / allDays
} 
...
console.log(
  ...
  // ------------------------
  document.getElementById("task-2/1").innerHTML = 
    calcAverageCalories([
      { day: "monday", calories: 3010 },
      { day: "tuesday", calories: 3200 },
      { day: "wednesday", calories: 3120 },
  ...
  document.getElementById("task-2/2").innerHTML = 
    calcAverageCalories([
      { day: "monday", calories: 2040 },
      { day: "tuesday", calories: 2270 },
      { day: "wednesday", calories: 2420 },
  ...
  document.getElementById("task-2/3").innerHTML = 
    calcAverageCalories([])
  ; // 0
